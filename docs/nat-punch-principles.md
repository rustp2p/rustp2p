...
flowchart TD
    ...
    subgraph PU["Puncher Backoff (punch/mod.rs: should_punch)"]
        ...
        BACK["batch_count above 8<br/>Linear backoff:<br/>interval = (batch_count / 8).min(360)<br/>Punch only when batch_count modulo interval equals zero"]
        FIRST --> BACK
    end
...
flowchart TD
    ...
    subgraph L3["Layer 3: Puncher backoff (punch/mod.rs:45 should_punch)"]
        ...
        L3C{"interval = (batch_count / 8).min(360)<br/>elapsed is at least interval?"}
